...
BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --second_offset $(BOARD_SECOND_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --recovery_dtbo $(BOARD_PREBUILT_DTBOIMAGE) --header_version $(BOARD_BOOTIMG_HEADER_VERSION)
