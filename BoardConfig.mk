...
BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --second_offset $(BOARD_SECOND_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --header_version 1
TARGET_PREBUILT_KERNEL := $(LOCAL_PATH)/prebuilt/zImage
BOARD_KERNEL_IMAGE_NAME := zImage

# DTBO Rules
BOARD_RECOVERY_DTBO_SIZE := 50828
BOARD_RECOVERY_DTBO_OFFSET := 0x15730688
